...
describe('Book Component', () => {
    ...
    test('Book is rendered correctly', () => {
        ...
        render(<Provider store={store}><BrowserRouter><Book book={book} /></BrowserRouter></Provider>);

        expect(screen.getByText('Learning Web Development with React and Bootstrap').textContent).toEqual(book.title);
