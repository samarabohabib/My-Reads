...
import { Column as IColumn} from "../../components/Column/Column.types";
...
describe('Home Component', () => {
    store.dispatch(booksActions.setBooks(books));
    store.dispatch(booksActions.setColumns(columns))
    ...
    test('Home is rendered correctly', () => {
        ...
        expect(screen.getByText('My Reads').textContent).toEqual('My Reads');
        expect(screen.getByText('enjoy drag and drop books').textContent).toEqual('enjoy drag and drop books');

        expect(screen.getByText('Want To Read').textContent).toEqual(columns[0].title);
        expect(screen.getByText('Currently Reading').textContent).toEqual(columns[1].title);
        expect(screen.getByText('Read').textContent).toEqual(columns[2].title);
